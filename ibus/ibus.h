#ifndef IBUS_SENSORS_LIB
#define IBUS_SENSORS_LIB

typedef enum {
    IBUS_SENSOR_TYPE_NONE             = 0x00, // internal voltage (in 0.01V)
    IBUS_SENSOR_TYPE_TEMPERATURE      = 0x01, // temperature (in 0.1 degrees, where 0=-40'C)
    IBUS_SENSOR_TYPE_RPM_FLYSKY       = 0x02,
    IBUS_SENSOR_TYPE_EXTERNAL_VOLTAGE = 0x03, // External voltage (in 0.01V)
